// CS2 specific JS - mostly identical to fivem.js with a few CS2-specific adjustments
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Background particle effect specific to CS2
    function createParticles() {
        ...
        for (let i = 0; i < particleCount; i++) {
            ...
            // Random position with bias toward top right (CS2 specific)
            particle.style.left = `${Math.random() * 50 + 50}vw`;
